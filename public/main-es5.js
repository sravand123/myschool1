...
var AdminLogInComponent = /** @class */ (function () {
    function AdminLogInComponent(formService, router) {
    ...
    AdminLogInComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.formService.loginAdmin(this.admin).subscribe(function (data) { _this.router.navigate(['index']); }, function (err) { _this.clicked = false; _this.errorMsg = true; });
    };
...
var AdminSignupComponent = /** @class */ (function () {
    function AdminSignupComponent(formService, router) {
        this.formService = formService;
        this.router = router;
    }
    ...
    AdminSignupComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.formService.signupAdmin(this.admin).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['admin', 'login']); });
    };
...
var Admin = /** @class */ (function () {
    ...
    Admin.ctorParameters = function () { return [
        { type: String },
        { type: String }
    ]; };
    return Admin;
...
var AllInOneService = /** @class */ (function () {
    function AllInOneService(http, auth, router) {
        this.http = http;
        this.auth = auth;
        this.router = router;
    ...
    AllInOneService.prototype.get_students = function () {
    ...
    AllInOneService.prototype.get_Classes = function () {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Subjects = function () {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Teachers = function () {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Marks = function () {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Class_Details = function (id) {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Subject_Details = function (id) {
        if (this.auth.isLoggedIn()) {
    ...
    AllInOneService.prototype.get_Index_Details = function () {
        if (this.auth.isLoggedIn()) {
            ...
            var classes = this.http.get(this.classUrl, { headers: { Authorization: "Bearer " + this.auth.getToken() } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
            var teachers = this.http.get(this.teacherUrl, { headers: { Authorization: "Bearer " + this.auth.getToken() } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
            var subjects = this.http.get(this.subjectUrl, { headers: { Authorization: "Bearer " + this.auth.getToken() } }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError));
    ...
    AllInOneService.prototype.handleError = function (errorResponse) {
    ...
    AllInOneService.ctorParameters = function () { return [
...
var AppComponent = /** @class */ (function () {
    function AppComponent(lBar, router) {
        var _this = this;
        this.lBar = lBar;
        this.router = router;
...
var ClassDetailsResolverService = /** @class */ (function () {
    function ClassDetailsResolverService(classDetailService) {
        this.classDetailService = classDetailService;
    }
    ClassDetailsResolverService.prototype.resolve = function (route, state) {
    ...
    ClassDetailsResolverService.ctorParameters = function () { return [
    ...
    return ClassDetailsResolverService;
}());
...
var ClassDetailsComponent = /** @class */ (function () {
    function ClassDetailsComponent(classService, route) {
    ...
    ClassDetailsComponent.prototype.applyFilter1 = function (filterValue) {
        this.dataSource1.filter = filterValue.trim().toLowerCase();
    };
    ClassDetailsComponent.prototype.applyFilter2 = function (filterValue) {
        this.dataSource2.filter = filterValue.trim().toLowerCase();
    };
    ClassDetailsComponent.ctorParameters = function () { return [
...
var ClassFormComponent = /** @class */ (function () {
    function ClassFormComponent(formService, router) {
        this.formService = formService;
        this.router = router;
    }
    ...
    ClassFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.formService.submitClass(this.class_).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['classes']); });
    };
    ClassFormComponent.ctorParameters = function () { return [
...
var IndexResolverService = /** @class */ (function () {
    function IndexResolverService(service) {
        this.service = service;
    }
    IndexResolverService.prototype.resolve = function (route, state) {
        return this.service.get_Index_Details();
    };
    IndexResolverService.ctorParameters = function () { return [
        { type: _all_in_one_service__WEBPACK_IMPORTED_MODULE_1__["AllInOneService"] }
    ]; };
...
var IndexComponent = /** @class */ (function () {
    function IndexComponent(route, service) {
        this.route = route;
        this.service = service;
        this.information = [];
    }
    IndexComponent.prototype.ngOnInit = function () {
        ...
        this.service.get_Index_Details().subscribe(function (data) {
            _this.information = data;
            _this.classes = _this.information[0];
            _this.teachers = _this.information[1];
            _this.subjects = _this.information[2];
            _this.dataSource2 = new _angular_material__WEBPACK_IMPORTED_MODULE_4__["MatTableDataSource"](_this.teachers);
            _this.show = true;
        });
    ...
    IndexComponent.prototype.applyFilter1 = function (filterValue) {
        this.dataSource1.filter = filterValue.trim().toLowerCase();
    };
    IndexComponent.prototype.applyFilter2 = function (filterValue) {
        this.dataSource2.filter = filterValue.trim().toLowerCase();
    };
...
var ClassResolverService = /** @class */ (function () {
    function ClassResolverService(classService, router) {
        this.classService = classService;
        this.router = router;
    }
    ClassResolverService.prototype.resolve = function (route, state) {
    ...
    ClassResolverService.ctorParameters = function () { return [
        { type: _all_in_one_service__WEBPACK_IMPORTED_MODULE_1__["AllInOneService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
...
var StudentResolverService = /** @class */ (function () {
    function StudentResolverService(studentService, router) {
        this.studentService = studentService;
        this.router = router;
    }
    StudentResolverService.prototype.resolve = function (route, state) {
        return (this.studentService.get_students())
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
            return rxjs_Observable__WEBPACK_IMPORTED_MODULE_1__["Observable"].of(err);
        }));
    };
    StudentResolverService.ctorParameters = function () { return [
...
var SubjectResolverService = /** @class */ (function () {
    function SubjectResolverService(subjectService, router) {
        this.subjectService = subjectService;
        this.router = router;
    }
    SubjectResolverService.prototype.resolve = function (route, state) {
        return this.subjectService.get_Subjects()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
            return rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].of(err);
        }));
    };
    SubjectResolverService.ctorParameters = function () { return [
        { type: _all_in_one_service__WEBPACK_IMPORTED_MODULE_2__["AllInOneService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var TeacherResolverService = /** @class */ (function () {
    function TeacherResolverService(teacherService, router) {
        this.teacherService = teacherService;
        this.router = router;
    }
    TeacherResolverService.prototype.resolve = function (route, state) {
        return this.teacherService.get_Teachers()
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (err) {
            return rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].of(err);
        }));
    };
    TeacherResolverService.ctorParameters = function () { return [
        { type: _all_in_one_service__WEBPACK_IMPORTED_MODULE_2__["AllInOneService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
    ]; };
...
var StudentDetailsComponent = /** @class */ (function () {
    ...
    StudentDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.students.forEach(function (element) {
            if (element._id === _this.route.snapshot.params.id) {
                _this.student = element;
...
var FormService = /** @class */ (function () {
    function FormService(Http, auth, router) {
        this.Http = Http;
        this.auth = auth;
        this.router = router;
    ...
    FormService.prototype.submitStudent = function (form) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.submitTeacher = function (form) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.updateTeacher = function (form, id) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.updateStudent = function (form, id) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.submitClass = function (form) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.submitMarks = function (id, value) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.signupAdmin = function (form) {
    ...
    FormService.prototype.loginAdmin = function (form) {
        var _this = this;
        var base = this.Http.post(this.logurl, form).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(this.errorHandler));
    ...
    FormService.prototype.getMarks = function (id) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.updateMarks = function (value) {
        if (this.auth.isLoggedIn()) {
    ...
    FormService.prototype.submitTest = function (value) {
        if (this.auth.isLoggedIn()) {
    ...
    //   }
    // }
    FormService.prototype.errorHandler = function (errorResponse) {
        if (errorResponse.error instanceof ErrorEvent) {
            console.error("client side error : " + errorResponse.status);
        }
        else {
...
var StudentFormComponent = /** @class */ (function () {
    function StudentFormComponent(router, route, formService) {
        this.router = router;
        this.route = route;
        this.formService = formService;
    }
    ...
    StudentFormComponent.prototype.validateClass = function (value) {
        if (value === 'default') {
            this.classEroor = true;
        }
        else {
    ...
    StudentFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.formService.submitStudent(this.student).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['index']); });
    };
    StudentFormComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] },
...
var Student = /** @class */ (function () {
    function Student(name, Class, roll, dob, father_name, mother_name, aadhar) {
        this.name = name;
        this.Class = Class;
        this.roll = roll;
        this.dob = dob;
...
var StudentUpdateComponent = /** @class */ (function () {
    function StudentUpdateComponent(router, route, formService) {
        this.router = router;
        this.route = route;
        this.formService = formService;
    }
    StudentUpdateComponent.prototype.ngOnInit = function () {
        ...
        this.students = this.route.snapshot.data.student;
        this.students.filter(function (user) {
            if (user._id === _this.selectedId) {
                _this.selectedStudent = user;
            }
        });
    ...
    StudentUpdateComponent.prototype.validateClass = function (value) {
        if (value === 'default') {
            this.classEroor = true;
        }
        else {
    ...
    StudentUpdateComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        console.log(this.student);
        this.formService.updateStudent(this.student, this.selectedId).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['students', _this.selectedId]); });
    };
...
var SubjectDetailsResolverService = /** @class */ (function () {
    function SubjectDetailsResolverService(service) {
        this.service = service;
    }
    SubjectDetailsResolverService.prototype.resolve = function (route, state) {
        return this.service.get_Subject_Details(route.params.id);
    };
    SubjectDetailsResolverService.ctorParameters = function () { return [
        { type: _all_in_one_service__WEBPACK_IMPORTED_MODULE_1__["AllInOneService"] }
    ]; };
    ...
    return SubjectDetailsResolverService;
}());
...
var SubjectFormComponent = /** @class */ (function () {
...
var TeacherDetailsComponent = /** @class */ (function () {
    function TeacherDetailsComponent(route) {
        this.route = route;
    }
    TeacherDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.teachers.forEach(function (element) {
            if (element._id === _this.route.snapshot.params.id) {
                _this.teacher = element;
                console.log(_this.teacher);
            }
        });
    };
    TeacherDetailsComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_1__["ActivatedRoute"] }
    ]; };
...
var Class = /** @class */ (function () {
    ...
    Class.ctorParameters = function () { return [
        { type: Number }
    ]; };
    return Class;
}());
...
var TeacherFormComponent = /** @class */ (function () {
    function TeacherFormComponent(formService, route, router) {
        this.formService = formService;
        this.route = route;
        this.router = router;
    }
    ...
    TeacherFormComponent.prototype.validateClass = function (value) {
        if (value === 'default') {
    ...
    TeacherFormComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.formService.submitTeacher(this.teacher).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['index']); });
    };
    TeacherFormComponent.ctorParameters = function () { return [
...
var Teacher = /** @class */ (function () {
    function Teacher(name, Class, subject, phone, email) {
    }
...
var TeacherUpdateComponent = /** @class */ (function () {
    function TeacherUpdateComponent(route, formService, router) {
        this.route = route;
        this.formService = formService;
        this.router = router;
    }
    TeacherUpdateComponent.prototype.ngOnInit = function () {
        ...
        this.selectedId = id;
        this.teachers.forEach(function (element) {
            if (_this.selectedId === element._id) {
                _this.selectedTeacher = element;
            }
        });
        ...
        this.teacher.Class = [];
        this.selectedTeacher.class.forEach(function (element) {
            _this.teacher.Class.push(element._id);
        });
    ...
    TeacherUpdateComponent.prototype.validateClass = function (value) {
        if (value === 'default') {
            this.subjectError = true;
        }
        else {
    ...
    TeacherUpdateComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        console.log(this.teacher);
        this.formService.updateTeacher(this.teacher, this.selectedId).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.router.navigate(['teachers', _this.selectedId]); });
    };
...
var TestFormComponent = /** @class */ (function () {
    function TestFormComponent(formService, router, route) {
        this.formService = formService;
        this.router = router;
        this.route = route;
    }
    ...
    TestFormComponent.prototype.validateClass = function (value) {
        if (value === 'default') {
            this.classError = true;
        }
        else {
    ...
    TestFormComponent.prototype.onSubmit = function () {
        ...
        this.formService.submitTest(this.test).subscribe(function (data) { _this.router.navigateByUrl('tests/' + data._id); }, function (err) { _this.clicked = false; _this.errorMsg = true; });
    };
...
var Test = /** @class */ (function () {
    function Test(name, Class) {
        this.name = name;
        this.Class = Class;
    }
    Test.ctorParameters = function () { return [
        { type: String },
        { type: String }
    ]; };
    return Test;
...
var TestMarksResolverService = /** @class */ (function () {
    function TestMarksResolverService(service) {
        this.service = service;
    }
    TestMarksResolverService.prototype.resolve = function (route, state) {
        return this.service.getMarks(route.params.id);
    };
    TestMarksResolverService.ctorParameters = function () { return [
    ...
    return TestMarksResolverService;
}());
...
var TestMarksComponent = /** @class */ (function () {
    function TestMarksComponent(route, service, router) {
        this.route = route;
        this.service = service;
        this.router = router;
        this.Information = [];
    }
    TestMarksComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.clicked = false;
        this.errorMsg = false;
        ...
        if (this.Information.length === 0) {
            ...
            console.log(this.Information);
            this.Information.forEach(function (element2) {
                _this.rowData.push({ test: _this.id, name: element2._id,
                    class: element2.class._id, Name: element2.name, Class: element2.class.class
                });
            });
        }
        else {
            this.Information.forEach(function (element) {
                _this.rowData.push({ test: element.test, Name: element.name.name,
    ...
    TestMarksComponent.prototype.onSubmit = function () {
        var _this = this;
        this.clicked = true;
        this.service.submitMarks(this.id, this.rowData).subscribe(function (res) { return console.log('HTTP response', res); }, function (err) { _this.clicked = false; _this.errorMsg = true; }, function () { _this.clicked = false; });
    };
    TestMarksComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _student_form_form_service__WEBPACK_IMPORTED_MODULE_1__["FormService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
